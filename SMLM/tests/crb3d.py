...
class CRB3D_Test1:
    ...
    def plot(self,ax1,ax2,nn=5):
        ...
        ax1.semilogx(N0space,pixel_size*rmse_mle[:,0],color='cornflowerblue',marker='x',label='MLE RMSE')
        ax2.semilogx(N0space,rmse_mle[:,2],color='purple',marker='x',label='z')
        ax1.set_xlabel('Photons per second')
...
class CRB3D_Test2:
    ...
    def plot(self,ax1,ax2):
        ...
        ax1.set_xlabel('z (nm)')
        ax1.set_ylabel('Localization error (nm)',color='cyan')
        ax2.set_ylabel('Localization error (nm)',color='purple')
        ax1.legend()
        ax2.legend()
