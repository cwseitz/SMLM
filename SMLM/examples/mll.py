...
for n in range(len(N0space)):
    #likex0[n] = isologlike(np.array([x0space[n],y0,sigma,N0]),adu,*cmos_params)
    #likey0[n] = isologlike(np.array([x0,y0space[n],sigma,N0]),adu,*cmos_params)
    #likesig[n] = isologlike(np.array([x0,y0,sigspace[n],N0]),adu,*cmos_params)
