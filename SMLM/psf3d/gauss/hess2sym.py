...
x, y, x0, y0, z0, s0, N0, eta, texp, gain, var = sp.symbols('x y x0 y0 z0 sigma N0 eta texp gain var')

sigma_x = s0 + 5.349139e-7*(z0+413.741)**2
sigma_y = s0 + 6.016703e-7*(z0-413.741)**2
